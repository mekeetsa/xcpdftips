...
\newlength{\XC@hGoal}   \setlength\XC@hGoal{0ex}
\newlength{\XC@hShift}  \setlength\XC@hShift{0ex}
...
\NewDocumentCommand{\ocgtooltip}{%
  ...
  \stepcounter{XC@tipn}%
  \ocgbase@new@ocg{xcite: \XC@keys}{%
    /Print<</PrintState/OFF>> %
    /Export<</ExportState/OFF>> %
    /View<</ViewState/OFF>> %
  }{invisible}%
  \edef\XC@currentOcg{\ocgbase@last@ocg}%
  ...
  \XC@pdfLink{%
    /Subtype/Link/Border[0 0 0]/A %
      <</S/SetOCGState/State [/Toggle \XC@currentOcg]>> %
  }{#1}%
  % Create a savebox for the <tooltip text> on the PDF layer
  \sbox\XC@tipText{%
    \ocgbase@oc@bdc{\XC@currentOcg}%
    \ocgbase@open@stack@push{\XC@currentOcg}%
